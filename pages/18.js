        ...
        <Navbar />
            <div className={styles.contain}>
                <div className={styles.header}>
                    ...
                    <h1 className={styles.text}>Perfect Dishes & Drinks for {Mantra}</h1>
                </div>
                    ...
                    <div className={styles.container}>
                        <div className={styles.block}>
                            <div>
                                ...
                                <h3 className={styles.text}>Braised Supreme Dried 15 Head Australian Xu Rong Abalone</h3>
                        ...
                        <div className={styles.block}>
                            <div>
                                ...
                                <h3 className={styles.text}>Four Treasure Soup, sea cucumber, fish maw, dried Hokkaido scallop, crab meat</h3>
                                <h3 className={styles.note}>Contains Shellfish, Gluten</h3>
                            </div>
                        ...
                        <div className={styles.block}>
                            <div>
                                ...
                                <h3 className={styles.text}>Wat Tan Black Bean Beef Ho Fun</h3>
                        ...
                        <div className={styles.block}>
                            <div>
                                ...
                                <h3 className={styles.text}>Crispy Duck <br/>Salad, watermelon, pomelo, cashew nut, macadamia nut, shallot, spicy yuzu sauce.</h3>
