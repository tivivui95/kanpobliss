        ...
        <div>
            <div className={styles.coverimgfull}>
                ...
                <div className='h-96 grid content-center nearwhite'>
                    ...
                    <div><h1 className='text-center text-4xl'>Six Healing Sound Guided Meditation</h1></div>
                    <div className='text-center p-4 text-2xl'>Inhale kindness Exhale anger</div>
                    
                </div>
                <div className='relative w-full h-80 -mt-20'>
                <Image src='/images/24/Group 154.png' alt='' layout='fill' objectFit='contain' />
                </div>
